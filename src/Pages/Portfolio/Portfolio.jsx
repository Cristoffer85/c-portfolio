...
import Flakeville2 from '../../assets/Flakeville2.png'
...
import Projektatorn from '../../assets/Projektatorn.png'
import Unnamed_game from '../../assets/Unnamed_game.png'
...
{/*Projektatorn -----------------------------------------------------------------------------------------------------------------------------------------------------------*/}
          <h3 id="Projektatorn" className="left-column">Projektatorn</h3>
          <p className="both-columns">Project generator, collaborative web application using GenAI. Built to promote programming collaboration and creation.</p>
          <img className="left-column" src={Projektatorn} alt="" title="Projektatorn"/>
            <div className="right-column link-container">
              <h2>TECHNOLOGIES USED:</h2>
              <p>Java, Angular, Google Gemini, RabbitMQ, MongoDB, Render.com, Netlify</p>
              <br /><br />
              
              <FiGithub /> <a href="https://github.com/Cristoffer85/Flakeville-server" target="_blank" rel="noopener noreferrer">Github link - Server</a><br />
              ...
              <IoHomeOutline /> <a href="https://www.projektatorn.se/" target="_blank" rel="noopener noreferrer">Projektatorn</a>
            </div>
          <hr className="both-columns"></hr>
{/*FlakeVille ------------------------------------------------------------------------------------------------------------------------------------------------------*/}
          <h3 id="FlakeVille" className="left-column">FlakeVille</h3>
          ...
          <img className="left-column" src={Flakeville2} alt="" title="Flakeville"/>
            <div className="right-column link-container">
              <h2>TECHNOLOGIES USED:</h2>
              <p>Java (Spring Boot), React, RabbitMQ, MongoDB, Azure</p>
              <br /><br />
...
{/*CO -----------------------------------------------------------------------------------------------------------------------------------------------------------*/}
          ...
          <img className="left-column" src={C} alt="" title="CO"/>
            <div className="right-column link-container">
              ...
              <FiGithub /> <a href="https://github.com/Cristoffer85/c-portfolio" target="_blank" rel="noopener noreferrer">Github link</a><br /><br />
...
{/*ByteBook -----------------------------------------------------------------------------------------------------------------------------------------------------------*/}
          ...
          <hr className="both-columns"></hr>
{/*Unnamed Game -----------------------------------------------------------------------------------------------------------------------------------------------------------*/}
          <h3 id="Unnamed-Game" className="left-column">Unnamed Game</h3>
          <p className="both-columns">Unnamed game with better gamephysics and easier scalability. Also built in swing but conversion to web/typescript is planned.</p>
          <img className="left-column" src={Unnamed_game} alt="" title="Unnamed Game"/>
            <div className="right-column link-container">
              <h2>TECHNOLOGIES USED:</h2>
              <p>Java (Swing)</p>
              <br /><br />
              
              <p>* Github repo is private, but feel free to ask for access through the contact form.</p><br />
